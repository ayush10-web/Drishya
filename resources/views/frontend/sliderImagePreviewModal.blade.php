<!-- Modal -->
@foreach ($sliders as $kk => $ss)
    <div class="modal fade" id="sliderImagePreviewModal{{$kk}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="z-index: 99999;">
        <div class="modal-dialog modal-dialog-centered" role="document" style="
        margin: 0;
        max-width: 100%;
        padding: 20px;
        margin-left: 15px;">
        <div class="modal-content" style="background-color: rgb(0,0,0,0.7);">
